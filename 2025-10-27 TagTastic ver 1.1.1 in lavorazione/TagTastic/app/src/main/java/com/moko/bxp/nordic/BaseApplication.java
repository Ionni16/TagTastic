...
public class BaseApplication extends Application {
    ...
    // AP 2025-04-16 spostamento variabile globale all'APP qui
    private static int iMTAutoWriteStatus;
    public int GetMTAutoWriteStatus() { return iMTAutoWriteStatus; };
    public void SetMTAutoWriteStatus(int val) { iMTAutoWriteStatus = val; };

    @Override
    public void onCreate() {
        super.onCreate();
        initXLog();
        iMTAutoWriteStatus = 0; // nessuna selezione
