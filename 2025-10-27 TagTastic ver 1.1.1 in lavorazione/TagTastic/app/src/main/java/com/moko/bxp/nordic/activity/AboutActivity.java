...
public class AboutActivity extends BaseActivity {
    ...
    public void onFeedback(View view) {
        if (isWindowLocked())
            return;
        File trackerLog = new File(BaseApplication.PATH_LOGCAT + File.separator + "TagTastic.txt");
        File trackerLogBak = new File(BaseApplication.PATH_LOGCAT + File.separator + "TagTastic.txt.bak");
        ...
        StringBuilder mailContent = new StringBuilder("TagTastic_");
